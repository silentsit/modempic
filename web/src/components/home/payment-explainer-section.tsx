    ...
    <section className="border-b border-[var(--border)] py-16 sm:py-20" aria-labelledby="payment-heading">
      <Container>
        ...
        <p className="mt-2 max-w-3xl text-[var(--muted-foreground)]">
          Seamless payment process. We accept payments in crypto, or you can use your credit/debit card to buy the crypto
          in 3 min - no KYC.
        </p>
        <div className="mt-8 max-w-3xl space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-6">
            ...
            <p className="mt-3 text-sm leading-relaxed text-[var(--muted-foreground)]">
              Crypto goes directly to our wallet. For card, open Guardarian to buy crypto, then return here to send funds
              and confirm your TxID.
            </p>
          </div>
        </div>
      </Container>
