      ...
      <section className="rounded-lg border border-[#dcdcde] bg-white p-5">
        ...
        <form action={updateSocialProofGlobalAction} className="mt-4 grid max-w-xl gap-4">
          ...
          <div className="space-y-1.5">
            ...
            >
              <option value="auto">Auto — real orders only (no invented purchases)</option>
              <option value="demo_only">Curated samples only — hide if no curated demo data</option>
              <option value="off">Off — hide purchase toasts when no real orders are available</option>
            </select>
            <p className="text-xs text-[#50575e]">
              Purchase toasts use paid orders. Auto no longer invents names, cities, or counts. Viewer counters use
              live presence heartbeats only.
            </p>
          </div>
          <label className="flex items-center gap-2 text-sm">
