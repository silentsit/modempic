...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CRYPTO', 'CARD_ONRAMP');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'REQUIRES_ACTION', 'SUCCEEDED', 'FAILED', 'EXPIRED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "CryptoAsset" AS ENUM ('USDT', 'BNB', 'BTC', 'USDC', 'USDS', 'PAXG');
